...
\begin{proof}
  ...
  the relevant glued objects are. Some consideration reveals that the
...
\[ i_{e} \circ \widetilde{\delta \circ i_{\pi}} \] The choice for \( d' \) is a more tricky
...
which should strike the reader as suspiciously similar to our glued morphism
...
The transpose of the lower composite in the original glued morphism diagram is
\( \reallywidetilde{\delta \circ i_{\pi} \circ (q_{X} \times q_{Y})}\); it can be rendered as a lambda
...
precisely the transpose of the lower composite in the original glued morphism
diagram.

The right-hand side of the desired equality is the transpose of the upper
composite in the glued morphism diagram so that the desired equality holds
