...
\begin{definition}[A presheaf of open syntactic terms]
  ...
  on \( t \) by the action of the clone model (c.f. Theorem~\ref{thm:clone
    model}), the above context-indexed family in fact defines a presheaf
  \[
...
\begin{definition}[A presheaf of neutral terms]
  For each $\tau \in \types$ and context \( \Gamma \in \ren \), the assignment
  \[
...
\begin{sketch}
  ...
  adjunction, so that it suffices to show an isomorphism
