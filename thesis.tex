...
\begin{definition}[Category of renamings]
  ...
  \( \mathbb{T} : \termob_{\mathfrak{Cat}} \rightarrow \catset \) be the functor which is
  constantly . Let \( U : \fin \rightarrow \catset \) be the forgetful functor taking
  finite variable sets to their underlying sets and functions to functions. Now
  by the \emph{category of renamings} we mean the \emph{opposite category} of
  the comma category \( U \downarrow \mathbb{T} \) whose
  \begin{itemize}
    \item Objects are \emph{pairs} \( (V : \fin, \Gamma : V \rightarrow \types) \), i.e.,
          ...
          adds no extra information. These objects are precisely the contexts of
    ...
    \]
          ...
          the second function would not communicate any data, it would just be
