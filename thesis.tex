...
\begin{definition}[Variable presheaf]
...
We can also explicate binding structure in \( \renhat \) via some special
contortions aided by the Yoneda lemma. Let \( \mathfrak{P} : \renhat \). Then
...
exponentials in $\renhat$ allow us to define notion of lambda algebras in
$\renhat$. In particular, a lambda algebra in $\renhat$ is comprised of a family
of presheaves \( \{\mathfrak{X}_{\tau}\}_{\tau\in \types}\) together with operations of
...
Finally we can give an interpretation of the syntactic category in terms of these
\begin{align*}
