...
and style (his course webpages are always out of this world cool). Jim and
...
while I was learning the ropes the ropes of CPU and hardware design. Working
together was a blast!

The acknowledgements that remain don't fit neatly into any of the above
categories, but should be said nonetheless: Thank you to Sara Rosenberger in the
business office for having my back when the office of financial aid left me to
rot. This thesis couldn't have happened without you!
...
and strange road to a thesis about glue!
...
example, makes it so that we may only meaningfully apply a function of type
...
lambda calculus always halt. In particular, this means that the lambda calculus
is \emph{not} Turing complete and can only solve \emph{decidable} problems. This
can be a problem for some applications. If you want, say, your web server to run
indefinitely without bound; the simply typed lambda calculus can't do that. You
could, however, make your program loop until the projected death of the sun and
deploy a new version of your server shortly thereafter. Having noted that there
are some workarounds to the problems arising from the terminating character of
the simply typed lambda calculus, it is interesting to note also that this very
character is actually required for some applications; for some purposes,
non-terminating languages have no such cute workarounds.
