...
categories of lambda theories satisfying the beta-eta rules. The proof is
inspired again by Taylor \cite{taylor_practical_1999} but ours is a tad shorter
because we take liberties in using more sophisticated language than he affords
himself at the point in the book.
...
\begin{proof}
  ...
  for the map is given by the The \( \beta\) rule is the universal property of the exponential
  transpose, and is hence satisfied.
