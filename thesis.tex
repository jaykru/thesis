...
%   Then \( \mathfrak{C} \) has all exponentials and all products. The map
...
\begin{proof}
  ...
  \( f_{i}\) are new variables and
  \begin{align*}
    F_{i} &= X_{1} \Rightarrow [X_{2} \Rightarrow \cdots [X_{j} \Rightarrow Y_{i}] \cdots] \\
    \ev{\overrightarrow{X},overrightarrow{Y}} &= [(\cdots(f_{1}(x_{1})x_{2}) \cdots x——]\circ[]
  \end{align*}
  \end{proof}
