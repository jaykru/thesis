...
to mathematically structure programming and opened me up to a world that had
until then had seemed inaccessible to me. Jim has also served as a great mentor
in matters of personal taste and style (his course webpages are always out of
this world cool.) I'll really miss our wacky math-cs crossover meetings, you
two!
...
師 (Hyong Rhew) for getting me to chill out a bit freshman year\footnote{and for
...
that there are some workarounds to the problems arising from the terminating
...
detailed in chapter theory. The class of normalization theorems of interest to
implementors of proof assistants is called the problem of \emph{open
...
original subterms) in our final check for equality of types.

Theorems such as closed and open normalization are conventionally proven by a
...
has the right type (as determined by the typechecker). In this sense, the design
of the gluing category allows us to impose some correctness criteria on all of
the intermediate syntactic transformations making up our normalization function
such that our correctness criteria immediately follow from having managed to
construct a normalization function of the ``correct type'' at all.
