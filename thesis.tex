...
We define the reify-reflect maps by induction on the type-former structure of
\( \types \):
\begin{definition}[Reify-reflect yoga]
  \begin{itemize}
    ...
    \[ \uparrow^{\tau} : \mu_{\tau*\tau'} \rightarrow \sem{\tau}_{\cl} \times \sem{\tau'}_{\cl}\] as the pair of the following composites:
    \begin{align*}
