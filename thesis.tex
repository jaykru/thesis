...
\begin{theorem}\label{thm:sem-pi-is-id-endofunctor}
...
\begin{proof}
  ...
  have that the composite \( n_{\tau} \circ \nf_{\tau}\) is the semantic projection
  \( \semproj \). So it suffices to show that
  \( \semproj (\downarrow^{\tau} \sem{\Gamma \vdash t : \tau}_{\gl} (\uparrow_{\Gamma}v_{\Gamma}) ) = \sem{\Gamma \vdash t : \tau}_{\cl} \).
  By Theorem~\ref{thm:sem-pi-is-id-endofunctor}, the interpretation of terms in
