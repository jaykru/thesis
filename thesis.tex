...
\begin{itemize}
  ...
  \item Equation preservation (TODO: not really sure I grok the important of
...
\[ \mathfrak{L}_{\tau}(\Gamma) \xrightarrow{(\Gamma \vdash t : \tau) \mapsto [t/x]} \cl[\Gamma, \tau] \xrightarrow{\sem{-}} \renhat \downarrow \tm [\sem{\Gamma}, \sem{\tau}] \xrightarrow{(\uparrow_{\Gamma} v_{\Gamma})^{*} \circ {\downarrow^{\tau}}_{*}} \renhat \downarrow \tm [\yoneda(\Gamma), \eta_{\tau}] \xrightarrow[\cong]{(d,\delta) \mapsto d(\id)} \nfpsh(\Gamma) \]
