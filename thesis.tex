...
NOT, AND, and OR as component circuits using transistors. The exact details of
how semiconductors work are beyond the scope of this thesis; it suffices to
...
transistor to illustrate this point. When the \emph{gate} input (labeled G
below) is high, electrons are able to flow from the \emph{source} input (labeled
S below) to the \emph{drain} output.
