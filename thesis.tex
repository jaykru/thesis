...
\begin{theorem}[Relative hom functor is cartesian closed]
  ...
  in full. It should basically follow from the Yoneda lemma.
\end{theorem}
...
reification and reflection maps above, and will prove crucial when demonstrating
that our normalization function computes normal forms with the same semantics as
the input term.
  ...
  equality.
    \begin{itemize}
      ...
      \item For the empty product/unit type \( \termob \), we have
            ...
            In the former case, I have no clue TODO. In the latter case, I have
            no clue either...TODO
    \item For types \( \tau, \tau' \in \types\), we define
    \[ \Uparrow^{\tau*\tau'} : \mu_{\tau*\tau'} \rightarrow \sem{\tau}_{\cl} \times \sem{\tau'}_{\cl}\] as the pair of the following composites:
    \begin{align*}
