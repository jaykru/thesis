...
\( \renhat \) together with the semantic \( NN \) algebra\footnote{i.e., the one
  induced by Remark~\ref{rmk:upgrade_to_stratified} and tthe usual lambda
  algebra in the classifying category} in the classifying category to get an
\( NN \) algebra in \( \renhat \downarrow \tm \).
