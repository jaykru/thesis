...
essential to recovering the relative monotonicity condition. To see why this
recovers what we had before, we need to look at the naturality diagram of
\( q \):
...
\begin{theorem}[Products in the gluing category]
  ...
  \( (\termob : \renhat, t : \termob \rightarrow \tm(\termob), termob : \cl) \) where and
