...
% Chaiyachakorn, Ms.\ Kim, 柳老師 (Hyong Rhew), Mrs.\ Leitsch, Mr.\ Raveli, Noah
% Koster, Shulav, Aditya, Francis, Alec, Joebob, Jit, Eli, Gabe and Ciara,
% Murali Vijayaraghavan, 吳老師, Ian Desai, Becca, Andres, Sara Rosenberger in
% the business office, the GNU project and free software foundation along with the developers of so many other free software projects whose generously donated works were instrumental in the production of this thesis.
...
\section{Trying to define presheaves of neutrals and normals: immediate
  catastrophe}
\section{New environment: the category of renamings}
\section{Substitutionary revisionism: presheaves of neutrals and normals}
\section{Working internally to presheaves? Or not.}
\section{The gluing category}
\subsection{The relative hom functor}
\subsection{The comma construction: two definitions and elementary examples}
