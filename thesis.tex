...
\renewbibmacro{in:}{} % suppress bad bibliography
...
\title{The Way of Glue\\ An Invitation to the Categorical Metatheory of Lambda
  Calculi} \author{Jay Kruer}
% The month and year that you submit your FINAL draft TO THE LIBRARY (May or December)
\date{December 2021}
% \division{Mathematics and Natural Sciences}
\advisor{Ang\'elica M. Osorno}
...
and for making this thesis possible. I am indebted to Ang\'elica's willingness
to take on this thesis during her sabbatical last spring. I am also grateful for
and in awe of her spooky ability to instantly grasp at understanding even in an
area relatively unknown to her. I could always count on and look forward to
Ang\'elica presenting me with a new insight into category-theoretic witchcraft
in each of our meetings; her influence on my thinking about categories is
reflected in these pages. Without her hints at how to tackle an opaque
construction every now and then, I think I'd probably be still fumbling around
with the basics. Jim has had an outsized influence on the direction my
intellectual life has taken, for which I am very grateful. Jim's intro CS course
taught partially in Standard ML was my first real exposure to mathematically
structure programming and put me on a road that until then had seemed
inaccessible. Jim has also served as a great mentor in matters of personal taste
and style (his course web pages are always out of this world cool). Jim and
Ang\'elica have both been very generous with their time during my thesis year,
especially in providing the comments that made this document something I'm proud
to my name on. I'll really miss our wacky math-cs crossover meetings, you two!
...
Now the acknowledgements become a tad less organized, but by no means less
sincere!

None of this would have been possible without my Mom and Dad. Thanks so much for
everything!

Jaclyn, my love, thank you for being everything to me over the past (almost!)
two years and for your friendship for the last (almost) four.

Thanks to my sister Megan for her unrelenting support, especially over the last
few challenging years! Thanks to my brother Ryan and my sister Kathleen for
always being there. Thank you to Uncle Jay for your constant encouragement for
my interests in computers. And to Grandma, Aunt Julie, Aunt Susie, and all of my
extended family for your continued support!

A few other teachers have made a huge impact on my life. My high school Chinese
...
Friends have made the last few years special: The following people made my time
at Reed. Thank you to Holden and Max for making WP117 home. Special thanks to
Max for not holding against me my having thrown a mug at him, and to Holden for
never violating the NAP. Thanks to Noah Koster for being one of my very first
friends at Reed and for always truckin'. You may not be the next Bill Gates, but
you're a great guy. Thanks to Nick Chaiyachakorn for always encouraging my
stupid computer purchases, and for just always being there for me. Thanks to
Yuta, Shulav, Jake, and Aditya for many fine hours of good lad time. Thanks to
Carter Fife for ditching us all and for being a massive weeb, to Dan Jeon for
telling everyone about that time he caught me practicing Naruto hand signs, to
Mary Brady for showing me the best song of the century (Freaky Friday by Lil
Dicky ft. Chris Brown), and to Salma Huque for being poggers. Thanks to Genya,
Tristan, and the rest of the crew for so many great nights in Polytopia. Special
thanks to Genya for comments on early versions of this thesis. More special
thanks go to Young Kim for corrupting my soul. Young, this thesis is in some
sense a tribute to you, because I know how much you love category theory. Thanks
also to Alice McKean for good times talkin' type theory and for comments on this
thesis. Thanks to the hyperbolic crew---Francis Baer, Alec Forget, Usman Hafiz,
Kiana McBride, and Luke Doms---for helping to make Kyle's wild ride a dummy good
time.

The following people made my time in Boston dummy based. Thanks to the many
friendbobs of pika: Joebob, Jit, Eli, Gabe, Ciara, Becca, Andres, Nathan, and
Chloe. The time I spent with you all in Boston was and remains precious to me
beyond measure! Thanks to Aaron Weiss for being a constant companion (even over
discord) over the last 3 years. I'm so glad we ended up labmates! Stay fresh,
king.

Sometimes lifeless (but not inanimate) objects deserve thanks too: thank you to
my beloved 1989 Toyota TownAce van which made the early pandemic an absolute
adventure. I'll miss you forever :'(

The following people have served as wonderful mentors to me in my scientific
career and in life in general. Thanks to Cody Roux and Dan McArdle (then at
Draper Lab) for guiding my early forays into formal methods and for heaps of
great life advice! My deep thanks go to Amal Ahmed for taking me on and guiding
my early studies of programming language theory during my leave from Reed. I
came to her with a lot of enthusiasm to learn and not much else, and she gave me
a wonderful opportunity to make good on that enthusiasm. Without her guidance I
would not be writing a thesis like this today, and I'll always be indebted to
the influence she's had on my way of thinking about programming language theory.
Thanks also to Murali Vijayaraghavan for his mentorship and patient instruction
while I was learning the ropes the ropes of CPU and hardware design.

The acknowledgements that remain don't fit neatly into any of the above
categories, but should be said nonetheless:
...
argument laid out in Chapter 3 and for helpful comments, and to Carlo Angiuli
(via Steve) for answering a long-standing question of mine about the category of
renamings.

Thank you to Ivan Di Liberti for many fun and useful mentorship Zoom meetings
...
My final thanks go to Jon Erickson, the author of \emph{Hacking: The Art of
  Exploitation} which got me started on this road so many years ago. What a long
and strange road to a thesis about huffing (in the strictly mathematical sense)
glue!
...
\chapter*{Abstract}
This thesis considers the \emph{open normalization} problem for the \emph{simply
  typed lambda calculus}. Elaborating on an extended abstract of Marcelo Fiore,
we ultimately produce a normalization function for open terms using the
\emph{Artin gluing} construction from category theory and topos theory. Getting
there demands some preliminaries, which, besides the assumed basic knowledge of
type theory and category theory, are built in the early chapters of this thesis.
We first develop the functorial semantics of type theories in the style of
Lawvere. After that, we examine how these ideas are used to provide an algebraic
theory of the lambda calculus whose algebras are essentially functors out of a
special category. Next, we develop the Artin gluing construction. The gluing
construction is then used to connect the syntax of the lambda calculus to its
semantics in the classifying category. Finally, we exploit the structure of the
resulting \emph{gluing category} to construct a normalization function and
provide easy proofs of its correctness.
% \chapter*{Dedication}
...
Though we will encounter many interesting objects and ideas along the way, this
thesis is primarily concerned with the \emph{open normalization} problem for the
\emph{simply typed lambda calculus}. Some explaining is in order. First, we'll
look at what is meant by the simply typed lambda calculus. The reader might be
familiar with the \emph{untyped} lambda calculus. The (untyped) lambda calculus
is a formal system oriented toward the study of functions and their
\emph{applicative} behavior \cite{barendregt_lambda_2012}. We define a notion of
function abstraction which allows us to select \emph{bound} variables from the
variables appearing in some mathematical phrase, as in \( \lambda x.\, x^{2}\). The
fundamental computational operation in the lambda calculus is
\emph{application}, which is defined in terms of \emph{substitution}. The
application of a function \( f \) to an argument \( a \) is denoted by
juxtaposition as in \[ f a. \] A more concrete example of application is
\( \sin \pi \). Function application is a derived notion; what application
\emph{does} is defined in terms of \emph{substitution}. For phrases (henceforth
called \emph{terms}) $e$ and $e'$, we impose an equation
\[ (\lambda x.\, e) e' = [e' / x]^{*}e \] called the \( \beta \)-\emph{law}. When
writing \[ [s/x]^{*} p, \] we mean the term given by taking the term $p$ and
replacing with $s$ every occurrence of $x$ appearing within. We have by the \( \beta\)-law, for example, that  \[
  (\lambda x.\, x^{2}) 3 = 3^{2}
\]
Authors more interested in the computational character of the \emph{lambda
  calculus} write
\[ (\lambda x.\, e) e' \rightarrow [e' / x]^{*}e\] so that the \( \beta \) principle is instead
...
machine, a more famous model of universal computation, are \emph{equivalent in
  computational power}. That is, any Turing machine can be simulated by a
program written in the lambda calculus and conversely the execution of any
program written in the lambda calculus can be simulated by some Turing machine.
Consequently, just as the Turing machine is a universal computer, the lambda
calculus is a universal programming language. That the lambda calculus is so
powerful is exciting, but some consider working with that full power unwieldy or
even dangerous. Indeed, there are programs that one can write down in the lambda
calculus which get ``stuck'' before computing a \emph{value}, meaning that there
are lambda programs $p$ which reduce to a $p'$ which isn't a value but cannot be
reduced to some $p''$. What constitutes a \emph{value} varies according to one's
inclinations. If, for example, we decide that the only values are lambda
abstractions and non-negative numerals (adding to the lambda calculus terms for
the natural numbers as appropriate) then the following terms are examples of
values
\begin{gather*}
    \lambda x.\, 5\\
    2\\
    \lambda x.\, 5\, (\lambda y.\, y)
\end{gather*}
while these terms are neither values nor stuck
\begin{gather*}
    (\lambda x.\, 5) 1\\
    (\lambda x.\, 5\, (\lambda y.\, y)) 1
\end{gather*}
while finally the term
\[
  5\, (\lambda y.\, y)
\]
is stuck because we have don't know to do with a numeral applied to an
abstraction and such a thing isn't one of our chosen values. This example
illustrates that stuckness is in some sense a coarse approximation for
\emph{bad} program states. Hence, the problem in the lambda calculus pointed to
above is that its definition allows us to write programs ending in \emph{bad}
states.
...
states (i.e., stuck terms) that we don't want to happen. These static guarantees
include, for example, ensuring that we only ever \emph{apply} abstractions, a
situation which would rule out our example stuck term above. The simplest
example of a typing regime is, appropriately, \emph{simple types}. The
simply-typed lambda calculus enriches the lambda calculus with some base types,
say booleans and natural numbers, along with derived types \( A \times B\)
representing \emph{pairs of terms} of the types $A$ and $B$ along with
\( A \Rightarrow B\) representing \emph{functions} taking an $A$ and giving a $B$. For
example, the type \( \mathbbm{B} \times \mathbbm{N}\) is inhabited by pairs of a
boolean and some natural number. Along with this type structure comes
\emph{rules} stipulating how it may be used. The rules for the arrow type, for
example, make it so that we may only meaningfully apply a function of type
\( \nat \Rightarrow \nat \) to a term of type \( \nat \); in particular, this setup rules
out the stuck term mentioned above, in that these rule mean that the term is not
\emph{well-typed} and so we will never try running it (or any program in which
it appears as a subterm). We will not explain this story in depth in this
thesis, but we will soon see these rules in Chapter~\ref{chapter:stlc}. The
desired result indeed follows from this setup: lambda terms that follow the
typing rules do not get stuck when evaluated. This is one instance of the famed
\emph{type safety} properties of programming language theory.

Another family of properties, namely \emph{normalization} properties, also
follows from this type regime. It turns out that any program in the lambda
calculus will reduce to a value in a finite number of evaluation steps. This
property is called \emph{closed normalization}. Borrowing the language of the
theory of Turing machines, this means that programs written in the simply typed
lambda calculus always halt. In particular, this means that the \emph{simply
  typed} lambda calculus is \emph{not} Turing complete and cannot express
computations encoded by non-halting Turing machines. This might be a problem for
some applications. If you want, say, your web server to run \emph{indefinitely}
without bound; the simply typed lambda calculus can't do that. You could,
however, make your program loop until the projected death of the sun (or with
some other finite bound) and then deploy a new version of your server shortly
thereafter. Similar workarounds allow us to use terminating languages for a
variety of other applications which ostensibly demand non-termination but in
reality demand much less. So it turns out that being forced to terminate is not
really so much of a problem, but conversely the possibility of non-termination
is a true problem for some applications. Those applications call for
\emph{proven} termination in the strict sense encoded by normalization theorems.
...
based on type\footnote{Here I am referring to type theory in the same sense as
  above for the simply typed lambda calculus. Only the type systems underlying
...
assistant; we will be deriving a term of type \texttt{False} (the type which has
no term constructors, and hence really ought to be uninhabited). You could
perform this same construction for any type you choose, even if it would be
redundant now that we have a \texttt{False} term (which gives us a term of any
other type by trivial case analysis). We first manually deactivate a Coq safety
feature expressly intended to rule out such definitions.
\begin{verbatim}
...
\emph{the method of logical relations}.\footnote{Normalization proofs actually
  ...
  \emph{logical relations}.} We will learn a bit more about logical relations
in the third chapter. The normalization theorem of interest to people concerned
...
The reason that such a device is interesting to implementors of proof assistants
is that proof assistants are usually based on \emph{dependent type systems}, in
which the language of types allows for the presence of general terms. Such
advanced type systems are the ones alluded to earlier in this introduction
during our discussion of the Curry-Howard isomorphism. The Curry-Howard
isomorphism casts the task of proof verification as the task of typechecking.
Because dependent type theory allows for arbitrary terms (and in particular
\emph{programs}) inside of types, the task of typechecking in this setting
amounts to deciding the equality of the final \emph{result} of arbitrary
subterms (and, in particular, arbitrary sub\emph{programs}). In the general
case, this problem is well-known to be undecidable. Using a \emph{normalizing}
term language makes it possible. Coming up with a \emph{normalization} function
\( \normalize \) which satisfies some key properties\footnote{Exactly which
  properties we will demand of our normalization function will be fully detailed
  in Chapter~4.} will allow us to compute normal forms for these subterms and
use those normal forms for the desired equality check. The desired property most
relevant to dependent typechecking is what I call \emph{equation reflection}
which says that for open terms \( t\) and \( t' \) of type \( \tau \) whose
free\footnote{Free variables are those variables appearing in a term which are
  not bound by a lambda abstraction.} variables come from some
\emph{context}\footnote{A context is nothing more than a list of variables
  together with their associated types.} \( \Gamma \) we have that
\[
...
commentary. In particular, I expect that the reader has a working knowledge of
type systems, grammars, etc. For these essentials, the reader is referred to
...
construction which frames the development enables us to give a more conceptual
treatment of this problem than conventional approaches allow for. Our particular
instance of the Artin gluing construction allows us to cast the normalization
problem as a simpler problem of finding a a morphism from one chosen object to
another chosen object inside of a specially structured category. The structure
of the category is such that each intermediate step taken along the path from
the first chosen object to the second chosen object must maintain a certain
invariant which ultimately will combine with an elementary fact to entail our
desired properties. One could liken this situation to the style of
\emph{type-directed programming} popular among functional programmers. In
\emph{type-directed programming}, one defines rich datatypes in terms of which
the functions comprising one's program are \emph{specified} before turning to
the task of actually writing them. These (possibly dependent) datatypes are used
to express a variety of correctness criteria about the functions such that any
function the programmer ultimately comes up with meets the specified properties
as long as it has the right type (as determined by the typechecker). In a
similar way, the design of the gluing category is like a strongly typed setting
in which to define and compose syntactic transformations. The structure of the
gluing category forces us to verify a certain correctness criterion \emph{as we
  go} while constructing the intermediate syntactic transformations so that,
besides one final totally straightforward verification about each of the
syntactic transformations, our desired correctness criteria for a normalization
function follow from simply having managed to construct a normalization function
of the ``correct type'' within the gluing category. I am remaining vague on this
...
\epigraph{The geometry of innocent flesh on the bone\\
Causes Galileo's math book to get thrown\\
At Delilah who's sitting worthlessly alone\\
But the tears on her cheeks are from laughter}{Bob Dylan, \emph{Tombstone Blues}}
...
\emph{unary} operations (those defined over a single parameter).

This restriction on the arity of operations turns out to be quite limiting. To
...
This chapter is strictly expository in nature; indeed, much of what follows
draws heavily from Paul Taylor's \emph{Practical Foundations of
  Mathematics}~\cite{taylor_practical_1999}. My contribution is to flesh out
some of the examples found there, add some of my own, and make other parts of
the presentation more palatable and quickly digestible to the reader already
...
We can give the syntactic category a model in the clones whose action is given
by substituting for variables, along the lines of Theorem~\ref{thm:clone model}.
...
\begin{proof}
  ...
  assignment of a function \( \ceil{r}_{A} : \ceil{X}_{A} \rightarrow \ceil{Y}_{A}\) to
  each operation-symbol \( X \vdash \ceil{r}(x) : Y\) such that the laws (given by
  Theorem~\ref{thm:canonical_elementary_language}) of \( \mathcal{L} \) are
  preserved. These assignments form precisely the data of a functor
  ...
  It remains to show functoriality of these assignments. Functoriality follows
  from the
...
the doctrine of \emph{algebraic theories}. This doctrine generalizes the
doctrine of elementary sketches and allows for multi-input operation symbols. As
we work through this upgrade in doctrine, many of the notions (\emph{terms,
  clones, syntactic category, etc.}) we developed in the simplified world of
elementary sketches will come along for the ride without much changed.
...
\begin{example}[Algebraic theory of \emph{ring}]\label{ex:theory of ring}
  ...
  \begin{enumerate}
    ...
    \item Laws: \begin{align*}
                ...
                \end{align*}
  \end{enumerate}
  Note that the countably infinite set of variables
  \( \{ s_{i}\}_{i\in\mathbb{N}}\) is added so that we may have deeply nested
  ...
  term, even in heavily nested terms, by construction.
\end{example}
...
symbol as a wire with low voltage applied. The AND and OR operations also enjoy
...
\begin{definition}[Extending a model to terms]\label{def:term model}
  ...
  expression in the final line, $\pi_{i}$ is the $i$-th projection guaranteed to
  us by the universal property of products, and $<_{!}$ is the unique map into
  the terminal object. The angle bracket notion is used to express the product
  functor's action on morphisms in $C$. For clarity, we write out explicitly the
  composites for the reader:
  \begin{align*}
...
a suite of simple type theories as a series of \emph{algebraic theories}
...
\begin{definition}[Algebraic theory of the lambda calculus]
  ...
  \begin{enumerate}
    ...
    \item We define the following operation symbols for each
         ...
         \begin{align*}
           \Gamma &\vdash (\lambda x:\tau'.\, t)(\overrightarrow{\gamma}) : \tau
         \end{align*}
...
\chapter{Artin gluing}\label{chapter:gluing}
\epigraph{You, you were like glue\\
  holding each of us together\\
  I slept through July\\
  while you made lines in the heather}{Fleet Foxes, \emph{Lorelai}}
...
\emph{operational} characterizations of normalization; we will see below
...
like \emph{the method of logical relations}. The method of logical relations is,
...
(see Pierce's textbook \cite{pierce_types_2002} or Harper's note
\cite{harper_how_nodate}). However, logical relations are well known to become
fiendishly complicated when working with theories whose type structure is more
complicated. Examples of such complexity include the addition of type system
features associated with computational effects, such as \emph{recursive types}
(the effect being non-termination) or \emph{mutable reference types} (the effect
being change of \emph{state}). Another variant of type safety presents a great
example of the problems associated with using logical relations in the presence
of these features.
...
relations. As in the case of normalization, proving semantic type safety by
logical relations is tedious by poses no problems for well-behaved type systems
like the simply typed lambda calculus. However, as alluded to above, not even
(ordinary) logical relations suffice when attempting to prove semantic type
safety for type systems with realistic features like \emph{mutable reference
  types}. The additional heavy machinery called for in cases like these is the
method of \emph{step-indexed logical relations}, a form of \emph{Kripke logical
  relations} which I describe briefly below and detail later in this chapter.
Ahmed, for example, employed \emph{step-indexed logical relations} to prove for
the first time the semantic type safety of a version of System F endowed with
mutable reference types in her doctoral thesis \cite{ahmed_semantics_2004}.
...
as \( n \leq m \). That is not a typo. The monotonicity condition, then, says that
a term is in the relation when allowed $k$ steps of reduction is also in the
relation when allowed \emph{fewer} steps of reduction
...
construction regularizes the thought involved and delivers more conceptual
proofs and theory. The gluing construction is perhaps overshadowed in fame by
one of its instances: The \emph{scone} or \emph{Sierpinski cone} is well-known
outside of type theoretic circles for its use in proving results similar to
closed normalization. Because we are interested in open normalization, the scone
...
meaning in the semantics (in the category \( \cl \)). As hinted at in the
introduction, the gluing construction is set up exactly so that morphisms in the
category are pairs of \emph{syntactic transformations} and \emph{semantic
  transformations} (namely substitutions) which in some sense commute the
semantic interpretation of terms in \( \cl \). Our normalization function, then,
will be acquired in Chapter~\ref{chapter:normalization} as a composite of these
glued morphisms. The proof of semantic equivalence of the input term and the
computed normal form is essentially automatic, following from the structure of
the gluing category and its morphisms together with one elementary fact proven
by induction on types. In this sense, the gluing category we work with has been
tailor made not just to mirror the type structure (as with logical relations) of
the simply-typed lambda calculus, but to also mirror the desired result.
...
\begin{definition}[Category of renamings]
  ...
  \begin{itemize}
    \item Objects are \emph{pairs} \( (V : \fin, \Gamma : V \rightarrow \types) \), i.e., a
          finite variable list together with an assignments of types to each
...
\epigraph{ I stood a-wondering which way to go\\
I lit a cigarette on a parking meter\\
And walked on down the road, it was a normal day}{Bob Dylan, \emph{Talkin' World War III Blues}} With our
prep-work out of the way and our course already sketched in the introduction to
the previous chapter, this chapter will quickly get underway with the remaining
work needed to construct our long-overdue normalization function for the simply
typed lambda calculus after one quick attributional note. The work done in this
chapter is heavily influence by an extended abstract of Fiore
\cite{fiore_semantic_2002}. The primary original contribution of this chapter is
to cast Fiore's work in terms of the language developed in the first two
chapters, which comes from Taylor \cite{taylor_practical_1999}. Taylor's notion
of algebraic theory is perhaps more digestible to the reader approaching this
work from computer science than the language Fiore works in; in kind, the
presentation here might be more appealing to such reader's than Fiore's original
extended abstract. I do leave out some observations and results from Fiore's
original paper, so I absolutely encourage to the reader to compare what follows
with the development Fiore presents. Besides this recasting, I also follow
Sterling and Spitters \cite{sterling_normalization_2018} in attempting
throughout to lower the abstraction level seen in Fiore's paper. For example,
Fiore's entire development is parameterized over a semantic interpretation of
terms in \( \cl \), whereas I fix an interpretation throughout. I do however, in
some places follow Fiore in work more abstractly where I feel it makes the
results more clear. In this sense, the work presented in this chapter can be
viewed as a mediating between these varying degrees of abstraction to find a
nice medium for a reader whose background is similar to my own. Throughout this
chapter, I present some proofs which are either fleshed out versions of
arguments given \emph{en-passant} in Fiore or else entirely original. These
proofs are marked as such.

Now then, let's get on with it! To begin, we set about defining some
\emph{presheaves of syntax} in \( \renhat\).
...
\( \NN\)-algebra mentioned above. It will turn out each of these glued morphisms
project in the semantics onto the identity, so that the first property is almost
trivial. The second property is even more immediate.
...
sketch is my own and has not been fully verified.
...
We write \( \sem{-}_{\gl} \) for both this functor and the interpretation of
syntax acquired by precomposing the functor with the usual interpretation of
terms in the classifying category. It is crucial to understand that though we
have \( \sem{\theta}_{\gl} = \mu_{\theta}\) for base types $\theta$, this equality does
\emph{not} hold at higher types \( \tau \in \types\). In the case of products, the
interpreted type \( \sem{\theta \times \theta'}_{\gl} \) is the actual product
