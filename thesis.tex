...
% Osorno, Irena Swanson, Kyle Ormsby, Amal Ahmed, Albyn Jones, Jaclyn, Nick
% Chaiyachakorn, Ms.\ King, 柳老師 (Hyong Rhew), Mrs.\ Leitsch, Mr.\ Raveli,
% Noah Koster, Shulav, Aditya, Francis, Alec, Joebob, Jit, Eli, Gabe and Ciara,
% Murali Vijayaraghavan, 吳老師, Ian Desai, Becca, Andres, Sara Rosenberger in
% the business office, the GNU project and free software foundation along with
% the developers of so many other free software projects whose generously
% donated works were instrumental in the production of this thesis.
...
\section{Trying to neutrals and normals inside the syntactic category: immediate catastrophe} % syntactic category quotients too much, we can't really say much about the computational behavior of these things
\section{New environment: The category of renamings}
% Definition as a comma, from Fiore; should also discuss some of its properties;
% is it Cartesian closed? What morphisms qualitatively are included?
\section{Presheaves of syntax}
% open terms, neutrals, normals
\section{Adapting the symbol pattern: lambda-algebras in ren-hat}
% ren hat is cartesian closed, and we will give an explicit structure for it

\section{The comma construction} % should note that we've already seen this
                                 % before in the section about the category of renamings
\section{A comma for closed terms: the scone} % This section will likely just be
                                              % a sketch following much the same
                                              % style set out in Shulman's note.
\subsection{The global section functor}
\subsection{Sconed consistency} % probs just STLC, or something.
\subsection{Sconed canonicity} % naturals
